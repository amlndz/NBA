...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div id="body_perfil">
      ...
      <div id="body_perfil_arriba">
        <div id="body_perfil_arriba_img">
          <div id="body_perfil_arriba_img_contorno">
            <img src="./assets/img/perfil.png">
          </div>
        </div>
        <div id="body_perfil_arriba_contenido">
          <div id="body_perfil_arriba_contenido_titulo">
            <h2>Bienvenido <?php echo $content['username']; ?></h2>
          </div>
          <div>
            <div>
              <?php echo $content['full_name']; ?>
            </div>
            <div>
          ...
          <div>
            <div>
              Jugador favorito: <?php echo $content['fav_player']; ?>
            </div>
            <div>
              Equipo favorito: <?php echo $content['fav_team']; ?>
            </div>
          </div>
        </div>
      </div>

      <div id="body_perfil_abajo">
        <form action="./modificarUsuarioAdministrador.php?iduser=<?php echo $idadmin; ?>" method="POST">
