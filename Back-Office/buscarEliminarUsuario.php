...
<head>
  ...
  <title>
    Panel de administracion - eliminar usuario
  </title>
  <!--     Fonts and icons     -->
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="buscarEliminarUsuario.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
      <div class="d-flex justify-content-end align-items-center w-100" id="navbar">
        <a href="perfil.php">
          <h2 class="mb-0 me-3" id="nombre_usuario">
            <?php 
    ...
    <div class="contenedor-titulo">
        <div class="titulo">-=-=-=- Eliminar un usuario -=-=-=-</div>
    </div>
  </main>
</body>