    ...
    <div class="col-lg-8 col-md-10 mx-auto">
      <div class="card mt-4">
        <div class="card-body p-3 pb-0">
          <div class="alert alert-secondary alert-dismissible text-white text-center" role="alert">
            <span class="text-lg">¡Advertencia! Al presionar este botón, se procederá a truncar y realizar una recarga en la base de datos utilizando los datos de una API externa. Esto puede resultar en cambios significativos en la base de datos y afectar a la integridad y consistencia de los datos almacenados. Antes de continuar, asegúrate de entender completamente el impacto de esta acción y de haber realizado una copia de seguridad de la base de datos actual. Solo debes proceder si estás seguro de que los datos de la API son correctos y deseas sobrescribir los datos existentes en la base de datos. Si tienes alguna duda, consulta con un administrador de base de datos o un experto en el tema.</span>
          </div>
        </div>
      </div>
      <div class="card mt-4">
        <div class="card-body p-3 pb-0">
          <div class="alert alert-primary alert-dismissible text-white text-center" role="alert">
            <span class="text-lg">¡Advertencia! Truncar una tabla eliminará todos los datos almacenados en ella de forma permanente. Esta acción no se puede deshacer y puede tener consecuencias graves en la integridad y funcionalidad de la base de datos. Antes de proceder, asegúrate de entender completamente el impacto de esta operación y de haber realizado una copia de seguridad de los datos relevantes. Solo debe truncar una tabla si estás absolutamente seguro de que es necesario y si tienes el permiso adecuado para hacerlo. Si tienes alguna duda, consulta con un administrador de bases de datos o un experto en el tema.</span>
          </div>
        </div>
      </div>
      <div class="card mt-4">
      ...
      <div class="text-center d-flex py-4 justify-content-center align-items-center">
        <form id="truncateButton" action="assets/funcionalidad/reload_tables.php" method="post">
          <button class="btn bg-gradient-danger mb-0 toast-btn" type="button" onclick="recarga_de_tablas()">Recargar tablas</button>
        </form> 
      </div>
